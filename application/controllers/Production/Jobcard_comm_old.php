...
/*
	...
	echo $docnotion."<br>";
	   ...
	   echo 'call Comm_Create_auto_imr("' . $IMRQuery . '","' . $docid . '","' . $icomapyid . '","' . $docnotion . '",@abc)';
	   die();
*/	   
...
//        print_r($Var_ID_Info1Array);
        ...
        for ($i = 0; $i < $sizeprid; $i++) {
            ...
            if ($pridArray_val == 'FC') {
                $cstringFC = "('FC','00035','" . $Var_ID_Info1Array_val . "' ,'" . $rawmaterialidArray_val . "','','','',0,'',0,0,'',''),";
                $data_value_FC = $data_value_FC . $cstringFC;
            }
            if ($pridArray_val == 'FL') {
                $cstringFL = "('FL','00006','" . $Var_ID_Info1Array_val . "' ,'" . $rawmaterialidArray_val . "','','','',0,'',0,0,'',''),";
                $data_value_FL = $data_value_FL . $cstringFL;
            }
//
            if ($pridArray_val == 'FF') {
                $cstringFF = "('FF','00007','" . $Var_ID_Info1Array_val . "' ,'" . $rawmaterialidArray_val . "','','','',0,'',0,0,'',''),";
...
//        
//        $rmcalc_arrayBBP = '';
//        foreach ($rawmaterialidArray as $key => $value) {
//            if($value != ''){
//            $arrayBBP_detail = "('BBP','00001','',
//                    '" . $value . "','',
//                    '','',
//                    '0','','" . $wasteperArray[$key] . "',                    
//                    '','',    
//                    ''),";
//            $rmcalc_arrayBBP = $rmcalc_arrayBBP . $arrayBBP_detail;
//            }
//        }
//        $UrlRMCalcBBP = substr_replace($rmcalc_arrayBBP, ";", -1);
//        if ($UrlRMCalcBBP != '') {
//            $rmc_BoardBBP = "insert into RMC_MaterialDetails_temp
//                            (PrID, GroupID, ProcessTypeID, ItemID, Item_DIM_Len, Item_DIM_Bre, 
//                             ItemID_DIM_Thick, ReqQty, ReqUnit,AddlInfo1, AddlInfo2, 
//                             CharInfo1, CharInfo2)
//                            values" . $UrlRMCalcBBP;
//        }        
//        
...
//        echo 'call comm_JC_RMC_Temp_Table("' . $rmc_ink . '","'.$rmc_Board.'","'.$BBPprocess.'","'.$FCprocess.'","'.$FFprocess.'","'.$FLprocess.'","","","","")';
//        die();

        $query = $this->db->query('call comm_JC_RMC_Temp_Table("' . $rmc_ink . '","' . $rmc_Board . '","' . $BBPprocess . '","' . $FCprocess . '","' . $FFprocess . '","' . $FLprocess . '","","","","")');
        if ($query->num_rows() > 0) {
...
//        echo '';
    ...
    public function RMCcalculateval() {
        ...
        if ($data_value_WP != '') {
            ...
            $wpprocess = "insert into RMC_MaterialDetails_temp (PrID, GroupID, ProcessTypeID, ItemID,Item_DIM_Len, Item_DIM_Bre, ItemID_DIM_Thick, ReqQty, ReqUnit,AddlInfo1, AddlInfo2, CharInfo1, CharInfo2)values" . $UrlContentWP;
        } else {
            $wpprocess = '';
        }
        if ($data_value_FC != '') {
            $UrlContentFC = substr_replace($data_value_FC, ";", -1);
            $FCprocess = "insert into RMC_MaterialDetails_temp (PrID, GroupID, ProcessTypeID, ItemID,Item_DIM_Len, Item_DIM_Bre, ItemID_DIM_Thick, ReqQty, ReqUnit,AddlInfo1, AddlInfo2, CharInfo1, CharInfo2)values" . $UrlContentFC;
        } else {
            $FCprocess = '';
        }
        ...
        if ($btn == 'Save') {
            ...
            foreach ($hdn_pprid as $key => $value) {
                ...
                if (isset($chk_delte[$key])) {
                    ...
                    $cstring = "('" . $AutoId_PK . "','" . $Docid . "','" . $Component . "','" . $FormNo . "','" . $PlateNo . "','" . $ProcessID . "', 
                        ...
                        '" . $FullSH_WithoutWastage . "','" . $PaperMulFact . "','" . $BoardDivFact . "','" . $CutBoardDim . "','" . $ProcessStatus . "','" . $dcnotionval . "','" . $osVendorID . "'),";
            ...
            if ($process != '') {
                $processdetail = "INSERT INTO webjobinfo_save_temp 
                    ...
                    TotFullSHRequired, FullSH_WithoutWastage, PaperMulFact,BoardDivFact,CutBoardDim,ProcessStatus, DocNotion,OsVendorID)VALUES" . $process;
            } else {
                $processdetail = '';
            }
            ...
            if (isset($txt_rawmaterial)) {
                foreach ($txt_rawmaterial as $key => $value) {
                    ...
                    $cstraw = "('" . $docidset . "','" . $txt_rawmaterialval . "','" . $txt_pcomponentnameval . "','" . $formno . "','" . $txt_Detailsval . "','" . $txt_apprxval . "', '" . $txt_otherdetailval . "', '" . $txt_unitval . "', '" . $txt_requestoccval . "', '" . $txt_materialstaval . "', '" . $txt_qtyallval . "', '" . $txt_imrval . "', '" . $txt_olditemidval . "', '" . $txt_olditemidval . "', '" . $txt_oldmatrialval . "', '" . $txt_recordidval . "', '" . $txt_allcatididval . "', '" . $txt_allocatmaterval . "', '" . $txt_Pridval . "', '" . $txt_processtaval . "', '" . $txt_Jobnoval . "', '" . $txt_codenoval . "', '" . $txt_gnameval . "','" . $dcnotionval . "'),";
                    $raw_value = $raw_value . $cstraw;
                }
                $raw_detail = substr_replace($raw_value, ";", -1);
                $raw_detail_insert = "insert into web_raw_save_detail(Docid,raw_material,Component,formno, Details, Approxqtyreq, Other_Detail,Unit, 
