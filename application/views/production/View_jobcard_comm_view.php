...
//             alert(jobneworold);
        ...
        $.ajax({
            ...
            for (var i = 0; i < processobj.length; i++) {
                ...
                // alert(processobj[i].ClientPaper);
                if (processobj[i].ClientPaper == 1) {
                    var chk_paper = "checked='checked'";
                }else{
                    var chk_paper = '';
                }
                ...
                $('#processdetail').append("<tr>\n\
                    ...
                    <td>\n\
                        ...
                        <input type='text' name='txt_pVar_Info2[" + k + "]' id='txt_pVar_Info2" + k + "' value='" + processobj[i].Var_Info2 + "' ></td>\n\
                    <td>\n\
                    ...
                    <td>\n\
                        <input type='hidden' name='hdn_pRawMaterialID_4[" + k + "]' id='hdn_pRawMaterialID_4" + k + "' value='"+processobj[i].RawMaterialID_4+"'>\n\
                        <input type='text' name='hdn_pRawMaterial_4[" + k + "]' id='hdn_pRawMaterial_4" + k + "' value='"+processobj[i].RawMaterial_4+"' readonly></td>\n\
                    ...
                    <td></td>\n\
                    <td><input type='checkbox' name='chk_clientpaper[" + k + "]' id='chk_clientpaper" + k + "' "+chk_paper+"></td>\n\
                </tr>");
            ...
            if (jobneworold == 'New' && objrawdetail == '') {
                ...
                for (var i = 0; i < objrawdetail.length; i++) {
                    ...
                    if (objrawdetail[i].PlateNo == 0) {
                        var plate = '';
                    }else{
                        var plate = objrawdetail[i].PlateNo;
                    }
                    $('#tbl_rawmaterial').append("<tr>\n\
                        <td class='rawdetailstyle' style='background-color: #FFDEAD'><input type='text' name='txt_rawmaterial[" + j + "]' id='txt_rawmaterial[" + j + "]' value='" + objrawdetail[i].raw_material + "'>\n\
                        <input type='hidden' name='hdn_RComponent[" + j + "]' id='hdn_RComponent[" + j + "]' value='" + objrawdetail[i].Component + "'>\n\
                        <input type='hidden' name='hdn_RFormNo[" + j + "]' id='hdn_RFormNo[" + j + "]' value='" + objrawdetail[i].FormNo + "'>\n\
                        <input type='hidden' name='hdn_RPlateNo[" + j + "]' id='hdn_RPlateNo[" + j + "]' value='" + objrawdetail[i].PlateNo + "'></td>\n\
                        <td>" + objrawdetail[i].Component + "</td>\n\
                        <td>"+ objrawdetail[i].FormNo +"</td>\n\
                        <td>"+ plate +"</td>\n\
    ...
    // }
     ...
     function showmachien(lnk) {
        ...
        $.ajax({
            ...
            var main = jQuery.parseJSON(msg);
            // var j = 1;
            $("#drp_machine").append("<option value='0'>--Select Machine--</option>");
            for (var i = 0; i < main.length; i++) {
                $("#drp_machine").append("<option value='" + main[i].MachineID + "|" + main[i].RecId + "|" + main[i].MachineName + "'>" + main[i].MachineName + "</option>");
            }
            var Fb = $("#txt_pfb" + lnk).val();
            $("#lbl_machineprinttype").text(Fb);
            var component = $("#txt_pcomponentname" + lnk).val();
            var formno = $("#txt_pformno" + lnk).val();
            var plateno = $("#txt_pplateno" + lnk).val();
            $('#lbl_machinecomponent').text(component);
            $('#lbl_machineformNo').text(formno);
            $('#lbl_machineplateNo').text(plateno);
    ...
    function ChangeMachine() {
        var drp_machine = $("#drp_machine").val();
        var arr = drp_machine.split('|');
        var macid = arr[1];
        $('#drp_plate').html('');
        $.blockUI();
        $.ajax({
            type: "POST",
            url: "<?php echo site_url() ?>Production/Jobcard_comm/drp_Platedetail",
            data: {drp_machine: macid}
        }).done(function (msg) {
            var main = jQuery.parseJSON(msg);
            
            $("#drp_plate").append("<option value='0'>--Select Plate--</option>");
            for (var i = 0; i < main.length; i++) {
                $("#drp_plate").append("<option value='" + main[i].Itemid + "|" + main[i].Description + "'>" + main[i].Description + "</option>");
            }
        });
    }

    function setformMachine() {
        var val = $("#hdn_lnprocessboard").val();
        var component_pop = $("#lbl_machinecomponent").text();
        var formno_pop = $("#lbl_machineformNo").text();
        var drp_machine = $("#drp_machine").val();
        var arr = drp_machine.split('|');
        var recid = arr[0];
        var macid = arr[1];
        var macname = arr[2];
        var drp_plate = $("#drp_plate").val();
        var arr1 = drp_plate.split('|');
        var plateid = arr1[0];
        var platename = arr1[1];
        ...
        for (var i = 1; i <= processdetailLen; i++) {
            ...
            if (component == component_pop && prid == 'Pr' && formno == formno_pop) {
                ...
                $("input[type='hidden'][name='hdn_pmachineno[" + i + "\\]']").val(recid);
                $("input[type='hidden'][name='hdn_pmachineid[" + i + "\\]']").val(macid);
                $("input[type='text'][name='txt_pmachinename[" + i + "\\]']").val(macname);

                // $("input[type='hidden'][name='hdn_pplateno[" + i + "\\]']").val(plateid);
                $("input[type='hidden'][name='hdn_pRawMaterialID_4[" + i + "\\]']").val(plateid);
                $("input[type='text'][name='hdn_pRawMaterial_4[" + i + "\\]']").val(platename);

        }
             $('#myModalMachienPr').modal('hide');
        }
    }

    function setprocessMachine() {
    ...
    function addprocess(val) {
        ...
        $('#processdetail').append("<tr>\n\
            ...
            <td>\n\
                <input type='text' name='txt_pVar_Info2[" + currnrow + "]' id='txt_pVar_Info2" + currnrow + "' value='' ></td>\n\
            <td>\n\
            ...
            <td>\n\
                    <input type='hidden' name='hdn_pRawMaterialID_4[" + currnrow + "]' id='hdn_pRawMaterialID_4" + currnrow + "' value=''>\n\
                    <input type='text' name='hdn_pRawMaterial_4[" + currnrow + "]' id='hdn_pRawMaterial_4" + currnrow + "' value='' readonly></td>\n\
            <td>\n\
    ...
    function validation() {
        ...
        if (closedate != '') {
            ...
            var month = arr[1];
            var yr = arr[2];
            var closedateval = yr + '-' + datea + '-' + month;
            alert(closedateval);
        ...
        var tbl_rawmaterial = $('#tbl_rawmaterial tr').length;
        if (tbl_rawmaterial == 0) {
            swal("Do you Want to save Please Click Raw material Button");
            return false;

        }
        var ptbllen = $('#processdetail tr').length;
        if (ptbllen == 0) {
            swal("Please Click Jobno Repopulate Data");
            return false;
        ...
        for (var i = 1; i <= ptbllen; i++) {
            ...
            var hdn_pRawMaterialID_4 = $("input[type='hidden'][name='hdn_pRawMaterialID_4[" + i + "\\]']").val();
            if (hdn_pprid == "FL") {
            ...
            if (hdn_pprid == "Pr") {
                if (hdn_pRawMaterialID_4 == "") {
                    swal("Please Select Plate In Printing..!");
                    return false;
                }
            }
            // alert(timePeriod);
...
//                
    ...
    function calculation_pop() {
        ...
        var wastage_sheets = Math.ceil((parseFloat(noOfcutSheets_without_Wastage) * wastage_pop) / 100);
        var wastage_calc = (Math.ceil(parseFloat(wastage_sheets) + parseFloat(noOfcutSheets_without_Wastage))).toFixed(0);
        $("#txt_popcutshwithoutwstge").val(parseFloat(noOfcutSheets_without_Wastage) * repeat);
        ...
        var cutsSheetBeforeWstge = $("#txt_popcutshwithoutwstge").val();
        var FB = $("#lbl_popprintingtype").text();
        if (FB == 'Self-Back') {
            var impression = wastage_calc * 2;
            $("#txt_popimpafterwstge").val(impression);
            $("#txt_popimpression").val(cutsSheetBeforeWstge * 2);
        } else {
            $("#txt_popimpafterwstge").val(wastage_calc);
            $("#txt_popimpression").val(cutsSheetBeforeWstge);
        }
...
//            });
    ...
    function Rmcalculate() {
        ...
        var txt_pVar_Info2Array = [];
        var hdn_pRawMaterialID_4Array = [];
        var PlateNoArray = [];
        var hdn_pint_Info1Array = [];
        ...
        for (var i = 1; i <= process_tr_length; i++) {
            ...
            // alert(txt_pVar_Info2);
            // if (Prid == 'Pr' && rawmaterialid!='') {
                ...
                var hdn_pRawMaterialID_4 = $("input[type='hidden'][name='hdn_pRawMaterialID_4[" + i + "\\]']").val();
                var txt_pplateno = $("input[type='text'][name='txt_pplateno[" + i + "\\]']").val();
                // console.log(txt_pplateno);
                var hdn_pint_Info1 = $("input[type='hidden'][name='hdn_pint_Info1[" + i + "\\]']").val();
                ...
                ComponentArray.push(Component);
                FormNoArray.push(FormNo);
                PlateNoArray.push(txt_pplateno);
                JobQtyArray.push(JobQty);

                rawmaterialidArray.push(rawmaterialid);
                wasteperArray.push(wasteper);
                hdn_pRawMaterialID_4Array.push(hdn_pRawMaterialID_4);

                PridArray.push(Prid);
                Var_ID_Info1Array.push(Var_ID_Info1);
                txt_pVar_Info2Array.push('');
                hdn_pint_Info1Array.push(hdn_pint_Info1);
                // console.log(PlateNoArray);

            // }else if(Prid!='Pr' && rawmaterialid!=''){
            //     var rawmaterialid = $("input[type='hidden'][name='hdn_prawmaterialid_1[" + i + "\\]']").val();
            //     var Component = $("input[type='text'][name='txt_pcomponentname[" + i + "\\]']").val();
            //     var FormNo = $("input[type='text'][name='txt_pformno[" + i + "\\]']").val();
            //     var txt_pVar_Info2 = $("input[type='text'][name='txt_pVar_Info2[" + i + "\\]']").val();
            //     var txt_pplateno = $("input[type='text'][name='txt_pplateno[" + i + "\\]']").val();
            ...
            //     PlateNoArray.push(txt_pplateno);
            //     Var_ID_Info1Array.push(Var_ID_Info1);
            //     txt_pVar_Info2Array.push(txt_pVar_Info2);
            //      wasteperArray.push(wasteper);
        ...
        $.ajax({
            ...
            data: {plateArray: plateArray, ink1Array: ink1Array, ink2Array: ink2Array,
                ...
                wasteperArray: wasteperArray, PridArray: PridArray, Var_ID_Info1Array: Var_ID_Info1Array,txt_pVar_Info2Array:txt_pVar_Info2Array,
                hdn_pRawMaterialID_4Array:hdn_pRawMaterialID_4Array,PlateNoArray:PlateNoArray,hdn_pint_Info1Array:hdn_pint_Info1Array},
            beforeSend: function () {
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    $("#tbl_rawmaterial").append("<tr>\n\
                        ...
                        <input type='hidden' name='hdn_RComponent[" + j + "]' id='hdn_RComponent[" + j + "]' value='" + data[i].Component + "'>\n\
                        <input type='hidden' name='hdn_RFormNo[" + j + "]' id='hdn_RFormNo[" + j + "]' value='" + data[i].FormNo + "'>\n\
                        <input type='hidden' name='hdn_RPlateNo[" + j + "]' id='hdn_RPlateNo[" + j + "]' value='" + data[i].PlateNo + "'>\n\
                        </td>\n\
        ...
        for (var i = 1; i <= btnval; i++) {
            ...
            $('#processdetail').append("<tr>\n\
                ...
                <td>\n\
                    ...
                    <input type='text' name='txt_pVar_Info2[" + k + "]' id='txt_pVar_Info2" + k + "' value='' ></td>\n\
                <td>\n\
                ...
                <td>\n\
                    <input type='hidden' name='hdn_pRawMaterialID_4[" + k + "]' id='hdn_pRawMaterialID_4" + k + "' value=''>\n\
                    <input type='text' name='hdn_pRawMaterial_4[" + k + "]' id='hdn_pRawMaterial_4" + k + "' value='' readonly></td>\n\
                <td>\n\
...
<div class="content-wrapper"> <!--  oncontextmenu="return false;"> -->
                                ...
                                <div class="tab-content">
                                    <div id="divReport">                        
                                        <div style="height:100px; overflow-x: auto;">
                                            ...
                                            <input hidden type="button" name="btn_machinePr" id="btn_machinePr" data-toggle='modal' data-target='#myModalMachienPr'>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" style=" margin-left:5px;  width: 100%; overflow-x: auto;overflow-y: auto;" id="example">
                                                <thead id="theadgeneral">
                                                    <tr class="trGeneral">
                                                        ...
                                                        <th style="width: 20%; "><center>Client Name</center></th>
                                                        ...
                                                        <th style="width: 10%; "><center>P.O. No.</center></th>
                                                        <th style="width: 3%;" hidden><center>Gang Job UPS</center></th>
                                                        <th style="width: 3%;">Final Qty. (With wastage)</th>
                                    ...
                                    <table id="tbl_processval" style="width: 150%;" class="paperclass">
                                        <thead id="theadgeneral">
                                            <tr class="trGeneral">                          
                                                ...
                                                <th style="white-space: nowrap;"><center>Plate Name</center></th>
                                                ...
                                                <th style="white-space: nowrap;"><center>Client Paper</center></th>
                                                </tr>
                                        </thead>
                                        <tbody id='processdetail'>
                                        </tbody>
                                    </table>
                                    <!-- <table id="tbl_processval" style="width: 270%;" class="paperclass">
                                        <thead id="theadgeneral">
                                            <tr class="trGeneral">                          
                                                <th style="width: 2%;"><center>Active</center></th>
                                                <th style="width: 5%;"><center>Component</center></th>
                                                <th style="width: 1%;"><center>Form No.</center></th>
                                                <th style="width: 1%;"><center>Plate No.</center></th>
                                                <th style="width: 5%;"><center>Process</center></th>
                                                <th style="width: 2%;"><center>F/B</center></th>
                                                <th style="width: 3%;"><center>Paper/Raw Material</center></th>
                                                <th style="width: 3%;"><center>Information1</center></th>
                                                <th style="width: 6%;"><center>Information2</center></th>
                                                <th style="width: 2%;"><center>Plan Size</center></th>
                                                <th style="width: 2%;"><center>Print Size</center></th>
                                                <th style="width: 1%;"><center>Repeat</center></th>
                                                <th style="width: 2%;">Cut Sheets</th>
                                                <th style="width: 1%;"><center>Wastage%</center></th>
                                                <th style="width: 1%;"><center>Impressions</center></th>
                                                <th style="width: 5%;"><center>Machine Name</center></th>
                                                <th style="width: 2%;">M/R Time</th>
                                                <th style="width: 2%;">Process Time</th>
                                                <th style="width: 2%;">Total Time</th>  
                                                <th style="width: 2%;"><center>Execution</center></th>  
                                                <th style="width: 2%;"><center>Pass</center></th>
                                                <th><center>Remarks</center></th>
                                                <th><center>Information3</center></th>
                                                </tr>
                                        </thead>
                                        <tbody id='processdetail'>
                                        </tbody>
                            ...
                            <div>
                                        ...
                                        <table class="tbl_ink" style="width:100%">
                                            <thead id="theadgeneral">
                                                <tr class="trGeneral">
                                                    ...
                                                    <th nowrap hidden><center>Plate</center></th>
                                                    <th nowrap hidden><center>New</center></th>
                                                    <th nowrap hidden><center>Old</center></th>
                                                    <th nowrap hidden><center>Remarks</center></th>
                                                    <th nowrap hidden><center>Execution</center></th>
                                ...
                                <div style="height:300px; width: 100%;overflow-x: auto;overflow-y: auto;height: 250px">
                                    <table class="tab_rawmaterial" style="width:100%">
                                        <thead id="theadgeneral">
                                                <tr class="trGeneral">                                
                                                <th style="width:25%;"><center>Raw Material Name</center></th>
                                                <th><center>Component</center></th>
                                                <th><center>Form No</center></th>
    ...
    <div id="myModalMachienPr" class="modal fade" role="dialog">
                ...
                <div class="modal-body form-body">
                    <table style="margin-left:20px;font-size:13px;">
                            <tr>
                                ...
                                <td colspan="4"><label id="lbl_machinecomponent" style="font-weight: 500;"></label></td>
                            </tr>
                            <tr>
                                <td align="right"><label>Form No. : </label></td>
                                <td align="left"><label id="lbl_machineformNo" style="margin-right: 25px; font-weight: 500;"></label></td>
                                <td align="right"><label>Plate No. : </label></td>
                                <td align="left" width="100px"><label id="lbl_machineplateNo" style="font-weight: 500;"></label></td>
                                <td align="right"><label>Printing type : </label></td>
                                <td align="left"><label id="lbl_machineprinttype" style="font-weight: 500;"></label></td>
                            </tr>
                        </table>
                    <br>
                    <div class="col-sm-12">
                        <div class="dataTable_wrapper" style="height: 200px; overflow-y: auto">
                            <div class="col-md-12">
                                <label>Select Machine :</label>
                                <select id="drp_machine" name="drp_machine" class='form-control' onchange='return ChangeMachine();' style="width: 100%"></select>
                            </div>
                            <div class="col-md-12">
                                <label>Select Plate :</label>
                                <select id="drp_plate" name="drp_plate" class='form-control' style="width: 100%"></select>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="padding: 10px;">
                        <button type="button" class="btn btn-primary" style="padding: 6px 8px;" onclick="setprocessMachine();">Apply to selected component</button>
                        <button type="button" class="btn btn-primary" style="padding: 6px 8px;" onclick="setformMachine();">Apply to selected form</button>
                    </div>
            </div>
        </div>
    </div>
