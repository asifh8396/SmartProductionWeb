...
//             alert(jobneworold);
        ...
        $.ajax({
            ...
            for (var i = 0; i < processobj.length; i++) {
                ...
                $('#processdetail').append("<tr>\n\
                    ...
                    <td>\n\
                        <input type='hidden' name='hdn_pplateno[" + k + "]' id='hdn_pplateno" + k + "' value=''>\n\
                        <input type='text' name='txt_pplatename[" + k + "]' id='txt_pplatename" + k + "' value='' readonly></td>\n\
    ...
    function setformMachine() {
        ...
        for (var i = 1; i <= processdetailLen; i++) {
            ...
            if (component == component_pop && prid == 'Pr' && formno == formno_pop) {
                ...
                $("input[type='text'][name='txt_pplatename[" + i + "\\]']").val(platename);
        }
    ...
    function addprocess(val) {
        ...
        $('#processdetail').append("<tr>\n\
            ...
            <td><input type='hidden' name='hdn_pplateno[" + currnrow + "]' id='hdn_pplateno" + currnrow + "' value=''>\n\
                <input type='text' name='txt_pplatename[" + currnrow + "]' id='txt_pplatename" + currnrow + "' value='' readonly></td>\n\
            <td>\n\
            ...
            $.ajax({
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#paperdescdatalist").append("<li class='wocpl' style='font-size:11px;'>\n\
                        ...
                        <a style='color:black;' href='javascript:void(0);' id='a_poppdescname" + i + "' onclick='set_paperdescdata(" + i + ")'>" + data[i].Description + "</a>\n\
                    </li>");
                }
    ...
    function manualjc() {
        ...
        for (var i = 1; i <= btnval; i++) {
            ...
            $('#processdetail').append("<tr>\n\
                ...
                <td><input type='hidden' name='hdn_pplateno[" + k + "]' id='hdn_pplateno" + k + "' value=''>\n\
                    <input type='text' name='txt_pplatename[" + k + "]' id='txt_pplatename" + k + "' value='' readonly></td>\n\
                <td>\n\
    ...
    <section class="content-header">
        ...
        <div class="pull-right">
            <div style="display: inline-block;margin-top: -6px;">
                <label style='width: 20px; height: 20px; background-color:#00FFFF; margin: 0px 4px; margin-bottom: -6px;border: 1px solid #000;'></label>
                ...
                <label style='width: 20px; height: 20px; background-color:#f2f7a4; margin: 0px 4px; margin-bottom: -6px;border: 1px solid #000;'></label>
